...
<?php
			...
			global $con;
				...
				$q1 = mysqli_query($con,"INSERT INTO product ( product_id,product_name, product_price, product_size, product_image, brand, category)
				VALUES ('$product_code','$product_name','$product_price','$product_size','$name', '$brand', '$category')");
				
				$q2 = mysqli_query($con,"INSERT INTO stock ( product_id, qty) VALUES ('$product_code','$qty')");
