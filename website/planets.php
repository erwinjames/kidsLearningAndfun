...
$name= mysqli_query($con,"select * from subject where categories='planets' order by id");

 while($res= mysqli_fetch_assoc($name))
{
echo '<hr>';
echo "<img style='text-align:center;' class='img-responsive' src=admin/uploaded_image/$res[image]>";
